...
/*** output ***/
void editorScroll() {
    E.rowoff = (E.cy < E.rowoff) ? E.cy : E.rowoff;
    E.rowoff =
        (E.cy >= E.rowoff + E.screenrows) ? E.cy - E.screenrows + 1 : E.rowoff;
}
...
void editorMoveCursor(int key) {
    switch (key) {
        ...
        case ARROW_DOWN:
            E.cy++;
            E.cy = (E.cy >= E.numrows) ? E.numrows - 1 : E.cy;
            break;
    }
}
...
void editorProcessKeypress() {
    ...
    switch (key) {
        ...
        // Home and end, start/end of line snapping
        case HOME_KEY: E.cx = 0; break;
        case END_KEY: E.cx = E.screencols - 1; break;

        // Page up/down cursor snapping
        case PAGE_UP:
        case PAGE_DOWN: {
